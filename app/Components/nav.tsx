      ...
      <div className={style.navDiv}>
        ...
        <div className={style.navLinks}>
          <span className={style.navLogged}>
            {userData != null ? (
              <>
                {userData.data()["nickName"]}님 환영합니다.&nbsp;|&nbsp;
                <span
              ...
              <>
                <Link href="/login" className={style.clickable}>
                  로그인
                </Link>
                &nbsp;|&nbsp;
                <Link href="/register" className={style.clickable}>
                  회원가입
                </Link>
              </>
            )}
            ...
            <>
              <Link href="/upload">
                <Image
                  ...
                  src="/images/nav/icon_upload.svg"
                  alt="업로드"
                  width={30}
                  height={30}
                />
              ...
              <Link href="/mypage">
                <Image
                  className={style.navIcon}
                  src="/images/nav/icon_mypage.svg"
                  alt="마이페이지"
                  width={30}
                  height={30}
                />
